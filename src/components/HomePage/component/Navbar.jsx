...
import { FaBars, FaSearch, FaChevronRight, FaGlobe } from "react-icons/fa";
    ...
    <Box py={4} mt={8}>
      ...
      >
        ...
        <Button
          ...
          borderRadius="full"
        >
          {user.isAuth? user.users[0].name:"Hej! Login or Sign Up"}
        </Button>
        <IconButton
          icon={<FiTruck />}
          aria-label="Shipping"
        ...
        >
          ...
          <DrawerContent boxShadow="lg" bg="#0058A3">
            <DrawerCloseButton
              _hover={{ bg: "white", borderRadius: "full" }}
              bg="white"
              borderRadius="full"
              size="md"
              position="absolute"
            ...
            <DrawerBody bg="#0058A3" p={0} overflow={"hidden"}>
              ...
              <VStack alignItems={"flex-start"} bg={"white"} p={4} h={290}>
          ...
          <DrawerContent bg="white" boxShadow="lg">
            ...
            <DrawerBody>
              ...
              <Box bg="black" borderRadius={"full"} color={"white"} px={4}>
                <IconButton icon={<BiCamera />} bg={"black"} />
                text Take or upload a photo
              </Box>

              <Text mb={4} fontSize={"sm"} w={"95%"} textAlign={"center"}>
                Your privacy is important to us! Please don't upload images with
                people in them. Images will only be used to improve search
                quality.
              </Text>
              ...
              <Box>
                <Image
                  src="https://www.ikea.com/in/en/search/images/visual-search-placeholder.svg"
                  alt="Additional Image"
                  mb={4}
                />
                <Text>
                  This is an additional section with an image and paragraph
          ...
          <DrawerContent bg="white" boxShadow="lg">
            ...
            <DrawerBody>
              <Grid templateColumns="20% 70%" gapx="10%">
                <GridItem>{/* Left column is blank */}</GridItem>
                <GridItem>
                  <VStack align="start" p={4}>
                    ...
                    >
                      {" "}
                      Products Rooms New at IKEA Offers
                    </Link>
                    ...
                    <Link fontWeight="bold">
                      Affordable accessories for everyday life
                    </Link>
