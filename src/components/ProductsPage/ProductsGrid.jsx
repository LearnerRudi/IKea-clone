                        ...
                        <Flex w={"35%"} mt={1}>
                            {   
                                ...
                                [...Array(Math.floor(elem.rating)).keys()].map(()=>{
                                    return <svg focusable="false" viewBox="0 0 24 24" class="pip-svg-icon pip-ratings-bar__star pip-ratings-bar__star--filled" aria-hidden="true"><path d="m12.0025 4 2.8593 4.9091 5.5524 1.2024-3.7852 4.2363L17.2012 20l-5.1987-2.2909L6.8038 20l.5723-5.6522-3.7853-4.2363 5.5524-1.2024L12.0025 4z"></path></svg>
                                }) : null
                            }
                            
                            {elem.rating > 0 ? <Text fontSize={15} >({elem.rating})</Text> : null}
                        </Flex>
                        <Flex mt={3}>
                            <Button p={0}  onClick={()=>{
